...
# # ── Your credentials ──────────────────────────────────────────
# SENDER_EMAIL    = "ewitewit451@gmail.com"   # ← your Gmail
# SENDER_PASSWORD = "hfbj mwjk wueh rbsb"       # ← 16-char app password (no spaces)

# def send_match_alert(family_email, person_name, confidence, latitude, longitude):
#     try:
...
#             <div style="background-color: #1a1a2e; padding: 24px; text-align: center; border-radius: 10px 10px 0 0;">
#                 <h1 style="color: white; margin: 0; font-size: 22px;">🔍 Missing Person Finder</h1>
#             </div>

#             <div style="background-color: #ff4d4f; padding: 16px; text-align: center;">
#                 <h2 style="color: white; margin: 0;">🚨 POSSIBLE MATCH FOUND</h2>
#             </div>

#             <div style="padding: 30px; background-color: #f9f9f9; border: 1px solid #eee;">

#                 <p style="font-size: 16px; color: #333;">
#                     Good news! Our system found a possible match for
#                     <strong>{person_name}</strong>.
#                 </p>

#                 <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
#                     <tr style="background-color: #e6f7ff;">
#                         <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold; width: 40%;">Person</td>
#                         <td style="padding: 12px; border: 1px solid #ddd;">{person_name}</td>
#                     </tr>
#                     <tr>
#                         <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold;">Match Confidence</td>
#                         <td style="padding: 12px; border: 1px solid #ddd; color: #52c41a; font-weight: bold;">{confidence}%</td>
#                     </tr>
#                     <tr style="background-color: #e6f7ff;">
#                         <td style="padding: 12px; border: 1px solid #ddd; font-weight: bold;">Coordinates</td>
#                         <td style="padding: 12px; border: 1px solid #ddd;">{latitude}, {longitude}</td>
#                     </tr>
#                 </table>

#                 <div style="text-align: center; margin: 30px 0;">
#                     <a href="{maps_link}"
#                        style="background-color: #1a1a2e; color: white; padding: 16px 32px;
...
#                 <div style="background-color: #fff3cd; padding: 16px; border-radius: 8px;
#                             border-left: 4px solid #ffc107; margin-top: 20px;">
#                     <strong>⚠️ Important:</strong> This is an AI-based match.
#                     Please verify in person and contact your local police station immediately.
#                 </div>
...
#         msg["X-Priority"]   = "1"  # marks as high priority
