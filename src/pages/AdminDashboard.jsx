...
//     }
//     setLoading(true);
//     setStatus("Adding missing person and scanning existing sightings...");

//     const formData = new FormData();
//     formData.append("image",        image);
//     formData.append("name",         name);
//     formData.append("age",          age);
//     formData.append("family_email", familyEmail);

//     try {
//       const res = await axios.post(
//         "http://localhost:5000/api/admin/add-missing",
//         formData,
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       setStatus(`✅ ${res.data.message} — scanning complete.`);
...
//           <h2 style={{ margin: 0 }}>➕ Add Missing Person</h2>
//           <button onClick={handleLogout} style={styles.logoutBtn}>Logout</button>
//         </div>

//         <div style={styles.uploadBox} onClick={() => document.getElementById("adminFile").click()}>
//           {preview
//             ? <img src={preview} alt="preview" style={styles.preview} />
//             : <div><div style={{ fontSize: "40px" }}>📷</div><p>Click to upload photo</p></div>
//           }
//         </div>
//         <input id="adminFile" type="file" accept="image/*" onChange={handleImageChange} style={{ display: "none" }} />
...
//         <input style={styles.input} placeholder="Family Email"  value={familyEmail} onChange={e => setFamilyEmail(e.target.value)} />
...
//         >
//           {loading ? "Processing..." : "Add & Scan for Matches"}
//         </button>

//         {status &&
//           <div style={{
//             ...styles.statusBox,
//             backgroundColor: status.startsWith("✅") ? "#e6ffed" : "#fff0f0",
//             borderColor    : status.startsWith("✅") ? "#52c41a" : "#ff4d4f",
//           }}>
//             {status}
//           </div>
//         }
...
//         {persons.length === 0
//           ? <p style={{ color: "#888" }}>No missing persons added yet.</p>
//           : persons.map(p => (
//               <div key={p.id} style={styles.personCard}>
//                 <div style={{ fontWeight: "bold", fontSize: "16px" }}>👤 {p.name}</div>
//                 <div style={{ color: "#666", fontSize: "13px" }}>Age: {p.age}</div>
//                 <div style={{ color: "#666", fontSize: "13px" }}>Email: {p.family_email}</div>
//                 <div style={{ color: "#999", fontSize: "12px" }}>Added: {new Date(p.added_at).toLocaleString()}</div>
//               </div>
//             ))
//         }
//       </div>
...
// const styles = {
//   page      : { padding: "30px", maxWidth: "700px", margin: "0 auto" },
//   card      : { backgroundColor: "white", borderRadius: "12px", padding: "30px", marginBottom: "24px", boxShadow: "0 4px 20px rgba(0,0,0,0.08)" },
//   uploadBox : { border: "2px dashed #1a1a2e", borderRadius: "10px", padding: "24px", textAlign: "center", cursor: "pointer", marginBottom: "14px", minHeight: "140px", display: "flex", alignItems: "center", justifyContent: "center" },
//   preview   : { maxWidth: "100%", maxHeight: "160px", borderRadius: "8px" },
//   input     : { width: "100%", padding: "11px", marginBottom: "12px", border: "1px solid #ddd", borderRadius: "8px", fontSize: "15px", boxSizing: "border-box" },
//   button    : { width: "100%", padding: "13px", backgroundColor: "#1a1a2e", color: "white", border: "none", borderRadius: "8px", fontSize: "15px", cursor: "pointer" },
//   statusBox : { marginTop: "14px", padding: "12px", borderRadius: "8px", border: "1px solid", textAlign: "center", fontSize: "14px" },
//   personCard: { padding: "14px", border: "1px solid #eee", borderRadius: "8px", marginBottom: "10px" },
//   logoutBtn : { padding: "8px 16px", backgroundColor: "#ff4d4f", color: "white", border: "none", borderRadius: "6px", cursor: "pointer" }
// };
...
//     }
//     setLoading(true);
//     setStatus("Adding and scanning all sightings...");
...
//         { headers: { Authorization: `Bearer ${token}` } }
//       );
//       setStatus("✅ Missing person added! All existing sightings scanned.");
//       setImage(null); setPreview(null);
//       setName(""); setAge(""); setFamilyEmail("");
//       fetchMissingPersons();
//     } catch (err) {
...
//         <div>
//           <div style={{ fontSize: "13px", opacity: 0.8 }}>Logged in as</div>
//           <div style={{ fontSize: "18px", fontWeight: "bold" }}>
//             {orgType === "police" ? "👮" : "🤝"} {orgName}
//           </div>
//         </div>
//         <button onClick={handleLogout} style={styles.logoutBtn}>Logout</button>
//       </div>
...
//       {/* Add Missing Person */}
//       <div style={styles.card}>
//         <h2 style={{ marginTop: 0 }}>➕ Add Missing Person</h2>
...
//         <input style={styles.input} placeholder="Full Name"    value={name}        onChange={e => setName(e.target.value)} />
//         <input style={styles.input} placeholder="Age"          value={age} type="number" onChange={e => setAge(e.target.value)} />
//         <input style={styles.input} placeholder="Family Email (alert will be sent here)" value={familyEmail} onChange={e => setFamilyEmail(e.target.value)} />
...
//       {/* Missing persons list */}
//       <div style={styles.card}>
//         <h2 style={{ marginTop: 0 }}>📋 Missing Persons ({persons.length})</h2>
//         {persons.length === 0
//           ? <p style={{ color: "#888", textAlign: "center" }}>No missing persons added yet.</p>
//           : persons.map(p => (
//               <div key={p.id} style={styles.personCard}>
//                 <div style={{ fontWeight: "bold", fontSize: "16px" }}>👤 {p.name}</div>
//                 <div style={{ color: "#555", fontSize: "13px", marginTop: "4px" }}>Age: {p.age}</div>
//                 <div style={{ color: "#555", fontSize: "13px" }}>Family Email: {p.family_email}</div>
//                 <div style={{ color: "#999", fontSize: "12px", marginTop: "4px" }}>
//                   Added: {new Date(p.added_at).toLocaleString()}
//                 </div>
//               </div>
//             ))
//         }
...
//   banner    : { backgroundColor: "#1a1a2e", color: "white", padding: "16px 24px", borderRadius: "12px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" },
//   card      : { backgroundColor: "white", borderRadius: "12px", padding: "28px", marginBottom: "20px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)" },
//   uploadBox : { border: "2px dashed #1a1a2e", borderRadius: "10px", padding: "24px", textAlign: "center", cursor: "pointer", marginBottom: "14px", minHeight: "130px", display: "flex", alignItems: "center", justifyContent: "center" },
//   preview   : { maxWidth: "100%", maxHeight: "150px", borderRadius: "8px" },
//   input     : { width: "100%", padding: "11px", marginBottom: "12px", border: "1px solid #ddd", borderRadius: "8px", fontSize: "15px", boxSizing: "border-box" },
//   button    : { width: "100%", padding: "13px", backgroundColor: "#1a1a2e", color: "white", border: "none", borderRadius: "8px", fontSize: "15px", cursor: "pointer" },
//   statusBox : { marginTop: "14px", padding: "12px", borderRadius: "8px", border: "1px solid", textAlign: "center", fontSize: "14px" },
//   personCard: { padding: "14px", border: "1px solid #eee", borderRadius: "8px", marginBottom: "10px" },
//   logoutBtn : { padding: "8px 18px", backgroundColor: "#ff4d4f", color: "white", border: "none", borderRadius: "6px", cursor: "pointer", fontWeight: "bold" }
// };
