...
//         formData
//       );
//       setStatus(`✅ Thank you! Sighting reported successfully. (ID: ${res.data.sighting_id})`);
//       setImage(null);
//       setPreview(null);
//     } catch (err) {
...
//         <h2 style={styles.title}>📸 Report a Sighting</h2>
//         <p style={styles.subtitle}>
//           Spotted someone who might be missing? Upload their photo here.
//           <br />No login required. Your report helps reunite families.
//         </p>
...
//                 <p style={{ fontSize: "13px", color: "#888" }}>JPG, JPEG, PNG supported</p>
//               </div>
//           }
//         </div>
//         <input
...
//         >
//           {loading ? "Scanning..." : "Submit Sighting"}
//         </button>
...
//   card      : { backgroundColor: "white", borderRadius: "12px", padding: "40px", width: "100%", maxWidth: "500px", boxShadow: "0 4px 20px rgba(0,0,0,0.1)" },
//   title     : { textAlign: "center", fontSize: "24px", marginBottom: "8px" },
//   subtitle  : { textAlign: "center", color: "#666", fontSize: "14px", marginBottom: "24px", lineHeight: "1.6" },
//   uploadBox : { border: "2px dashed #1a1a2e", borderRadius: "10px", padding: "30px", textAlign: "center", cursor: "pointer", marginBottom: "16px", minHeight: "180px", display: "flex", alignItems: "center", justifyContent: "center" },
...
//   statusBox : { marginTop: "16px", padding: "12px", borderRadius: "8px", border: "1px solid", textAlign: "center", fontSize: "14px" },
//   locationText: { fontSize: "13px", color: "#888", textAlign: "center", marginBottom: "8px" }
// };
